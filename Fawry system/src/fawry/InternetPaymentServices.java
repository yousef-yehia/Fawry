...
public class InternetPaymentServices implements Service { //template method pattern
	static ArrayList<Provider> providers = new ArrayList<Provider>();
	
	public InternetPaymentServices(ArrayList<User> userList, int indexOfActive) {
